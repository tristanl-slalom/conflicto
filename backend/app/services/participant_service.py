...
class ParticipantService:
    ...
    async def get_session_participants(self, session_id: int) -> List[ParticipantStatus]:
        """
    ...
    async def _generate_nickname_suggestion(self, session_id: int, base_nickname: str) -> Optional[str]:
        """
