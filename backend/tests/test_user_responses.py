...
class TestUserResponseModels:
    ...
    def test_nested_response_structure(self):
        ...
        assert (
            nested_response.response_data["participant_info"]["completion_percentage"]
            == 75
        )

    def test_empty_response_data(self):
        """Test handling of empty response data."""
        empty_response = UserResponseCreate(response_data={})
    ...
    def test_response_validation(self):
        ...
        # Valid response data
        valid_response = UserResponseCreate(response_data={"valid": True})
...
class TestUserResponseAPIPlaceholder:
    ...
    def test_api_endpoints_not_implemented(self):
        ...
        assert all(
            "user-responses" in endpoint or "responses" in endpoint
