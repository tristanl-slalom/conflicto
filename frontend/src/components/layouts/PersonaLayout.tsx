...
export function PersonaLayout({ persona, title, subtitle, children, className }: PersonaLayoutProps) {
  const styles = personaStyles[persona]
  
  return (
    <div className={cn(`min-h-screen bg-gradient-to-br ${styles.bg} text-white`, className)}>
      <div className="bg-slate-800/80 backdrop-blur-sm border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex items-center gap-3">
                <div className={`w-8 h-8 bg-gradient-to-r ${styles.gradient} rounded-lg flex items-center justify-center`}>
